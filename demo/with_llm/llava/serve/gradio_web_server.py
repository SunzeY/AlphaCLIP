...
title_markdown = ("""
# 🌋 LLaVA with Alpha-CLIP: Prompting MLLM with any region you want to highlight.
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/examples/extreme_ironing.jpg", "What is this?"],
                    [f"{cur_dir}/examples/waterview.jpg", "What is this?"],
